...
parrafo2.onclick = nuevaFuncion2;
parrafo1.onclick = () => {
    nuevaFuncion(1);
}
// crear el div...
...
console.log('diste click desde la nueva funcion');


}

function nuevaFuncion2(){
    console.log('diste click desde la nueva funcion 2');
    
    
    }

    function nuevaFuncion3(){
        console.log('diste click desde la nueva funcion 3');
